<template>
  <div v-if="show" id="page-preloader"><span class="spinner"></span></div>
</template>
<script>
  ...
  *
  *    // 显示页面 loading
  *    this.$store.commit('menudata/modShowPageLoading',true);
  *    // 隐藏 loading
  *    this.$store.commit('menudata/modShowPageLoading',false);
  *
  * */
  export default {
    name: 'Loading',
...
<style>
  ...
  /****** LOADER ******/
  #page-preloader { position: fixed; left: 0; top: 0; right: 0; bottom: 0; width: 100%; height: 100%; background: rgba(255,255,255,.3); z-index: 100500; }
